...
import { OrbitControls, ContactShadows, Float, KeyboardControls,useKeyboardControls } from '@react-three/drei'
...
import PictureFrame from '../three/components/cuadro'
    ...
    >
      ...
      >
        ...
        <group position-y={-0.5}>
         ...
         <PictureFrame url="textures/mesa/mesa_normal.jpg" position={[-2.45, 2.5, 0]} rotation-y={Math.PI / 2} />
        <group>
          <Mesa position={[0, 2, 0]} />
        </group>
